...
{
    return (file_page_id << MappingSnapshot::TypeBits) |
           uint64_t(MappingSnapshot::ValType::FilePageId);
}
    ...
    "[manifest-payload]")
{
    ...
    std::string_view payload = manifest.substr(ManifestBuilder::header_bytes);
